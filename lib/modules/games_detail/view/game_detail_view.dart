                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            if (game.rating != null)
                              Text(
                                  'Metacritic: ${game.rating!.toStringAsFixed(1)}',
                                  style: const TextStyle(
                                      color: Colors.white, fontSize: 14)),
                              ...
                              SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    final genre = game
                                        .genres![index % game.genres!.length];
                                    return Padding(
                  ...
                  Column(
                    ...
                    children: [
                            ...
                            if (controller.isOwned.value) {
                              ...
                              return ElevatedButton(
                                onPressed: controller.isAdding.value
                                    ? null
                                    : () =>
                                        _showProviderSelectionAndAdd(context),
                                child: Text(
                      ...
                      Obx(() {
                        ...
                        final currentStatus =
                            controller.gameDetails.value?.status ??
                                GameStatus.NUNCA_JOGADO;
                                  ...
                                  onChanged: (status) {
                                    if (status != null) {
                                      controller.updateStatus(
                                          status); // atualiza o estado e backend
                                    }
                                  },
