...
Obx(() => controller.isDropdownOpen.value
    ? Column(
        children: [
          ...
          // Lista de plataformas vinculadas com sync icon centralizado
          ...controller.linkedAccounts.entries.map((entry) {
            ...
            return Card(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    // Parte esquerda: Ícone + Nome da plataforma
                    Row(
                    ...
                    // Espaço flexível para empurrar o sync icon ao centro
                    Expanded(
                      child: Center(
                        child: IconButton(
                          onPressed: () => controller.reloadSteamAccount(),
                          icon: const Icon(
                            Icons.sync,
                            color: Color.fromRGBO(34, 132, 230, 1),
                            size: 28,
                          ),
                          tooltip: 'Sincronizar Jogos',
                        ),
                      ),
                    ),

                    // Botão Vincular / Vinculado alinhado à direita
                    ElevatedButton(
